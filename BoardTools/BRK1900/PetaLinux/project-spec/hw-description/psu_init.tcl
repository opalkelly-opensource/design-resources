...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0xFFFFFFFF 0x00004000
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFD1A0100 0x00000046 0x00000000
		# : RESET BLOCKS
		# : TIMESTAMP
    ...
    mask_write 0XFF0A0244 0x03FFFFFF 0x00001000
		# : DIR MODE BANK 2
    ...
    mask_write 0XFF0A0248 0x03FFFFFF 0x00001000
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xEFFF1000
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xEFFF0000
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 5 MS DELAY
    ...
    mask_write 0XFF0A0204 0x03FFFFFF 0x00000008
		# : DIR MODE BANK 1
		# : DIR MODE BANK 2
		# : OUTPUT ENABLE BANK 0
    ...
    mask_write 0XFF0A0208 0x03FFFFFF 0x00000008
		# : OUTPUT ENABLE BANK 1
		# : OUTPUT ENABLE BANK 2
		# : MASK_DATA_0_LSW LOW BANK [15:0]
    ...
    mask_write 0XFF0A0000 0xFFFFFFFF 0xFFF70008
		# : MASK_DATA_0_MSW LOW BANK [25:16]
		# : MASK_DATA_1_LSW LOW BANK [41:26]
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
    ...
    mask_write 0XFF0A0000 0xFFFFFFFF 0xFFF70000
		# : MASK_DATA_0_MSW LOW BANK [25:16]
		# : MASK_DATA_1_LSW LOW BANK [41:26]
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
...
set psu_serdes_init_data {
    ...
    mask_write 0XFD410014 0x00000077 0x00000032
		# : CHECKING PLL LOCK
