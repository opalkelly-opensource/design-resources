...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFFFFFU ,0x00004000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0xFFFFFFFFU, 0x00004000U);
/*##################################################################### */
...
unsigned long psu_peripherals_init_data(void)
{
    ...
    * (OFFSET, MASK, VALUE)      (0XFD1A0100, 0x00000046U ,0x00000000U)
    */
	PSU_Mask_Write(CRF_APB_RST_FPD_TOP_OFFSET, 0x00000046U, 0x00000000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_GPIO_DIRM_1_DIRECTION_1                                 0x1000

    * Direction mode (GPIO Bank1, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0244, 0x03FFFFFFU ,0x00001000U)
    */
	PSU_Mask_Write(GPIO_DIRM_1_OFFSET, 0x03FFFFFFU, 0x00001000U);
/*##################################################################### */
    ...
    *  PSU_GPIO_OEN_1_OP_ENABLE_1                                  0x1000

    * Output enable (GPIO Bank1, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0248, 0x03FFFFFFU ,0x00001000U)
    */
	PSU_Mask_Write(GPIO_OEN_1_OFFSET, 0x03FFFFFFU, 0x00001000U);
/*##################################################################### */
    ...
    *  PSU_GPIO_MASK_DATA_1_LSW_MASK_1_LSW                         0xefff

    * Operation is the same as MASK_DATA_0_LSW[DATA_0_LSW]
    *  PSU_GPIO_MASK_DATA_1_LSW_DATA_1_LSW                         0x1000

    * Maskable Output Data (GPIO Bank1, MIO, Lower 16bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A0008, 0xFFFFFFFFU ,0xEFFF1000U)
    */
...
/*##################################################################### */
    ...
    * Maskable Output Data (GPIO Bank1, MIO, Lower 16bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A0008, 0xFFFFFFFFU ,0xEFFF0000U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_1_LSW_OFFSET,
...
/*##################################################################### */
    ...
    *  PSU_GPIO_DIRM_0_DIRECTION_0                                 0x8

    * Direction mode (GPIO Bank0, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0204, 0x03FFFFFFU ,0x00000008U)
    */
	PSU_Mask_Write(GPIO_DIRM_0_OFFSET, 0x03FFFFFFU, 0x00000008U);
/*##################################################################### */
    ...
    *  PSU_GPIO_OEN_0_OP_ENABLE_0                                  0x8

    * Output enable (GPIO Bank0, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0208, 0x03FFFFFFU ,0x00000008U)
    */
	PSU_Mask_Write(GPIO_OEN_0_OFFSET, 0x03FFFFFFU, 0x00000008U);
/*##################################################################### */
    ...
    *  PSU_GPIO_MASK_DATA_0_LSW_MASK_0_LSW                         0xfff7
    ...
    *  PSU_GPIO_MASK_DATA_0_LSW_DATA_0_LSW                         0x8

    * Maskable Output Data (GPIO Bank0, MIO, Lower 16bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A0000, 0xFFFFFFFFU ,0xFFF70008U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_0_LSW_OFFSET,
		0xFFFFFFFFU, 0xFFF70008U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Maskable Output Data (GPIO Bank0, MIO, Lower 16bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A0000, 0xFFFFFFFFU ,0xFFF70000U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_0_LSW_OFFSET,
		0xFFFFFFFFU, 0xFFF70000U);
/*##################################################################### */
