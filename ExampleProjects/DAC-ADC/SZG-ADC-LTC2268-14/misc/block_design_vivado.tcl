...
set design_name adc_dac_tester
...
set wrapperfile [make_wrapper -files [get_files adc_dac_tester.bd] -top -import]
set_property top adc_dac_tester_wrapper [current_fileset]
