...
## Timing
############################################################################
set_property CLOCK_DEDICATED_ROUTE BACKBONE [get_nets adc_dac_example_i/clk_wiz_0/inst/clk_out1]
...
set_false_path -reset_path -from [get_clocks -of_objects [get_pins adc_dac_example_i/frontpanel_0/inst/okHI/mmcm0/CLKOUT0]] -to [get_clocks -of_objects [get_pins adc_dac_example_i/syzygy_dac_top_0/inst/dac_phy_impl/phy_pll/inst/mmcme4_adv_inst/CLKOUT0]]
set_false_path -reset_path -from [get_clocks -of_objects [get_pins adc_dac_example_i/frontpanel_0/inst/okHI/mmcm0/CLKOUT0]] -to [get_clocks -of_objects [get_pins adc_dac_example_i/clk_wiz_0/inst/mmcme4_adv_inst/CLKOUT0]]

# ADC timing constraints
create_clock -period 6.250 -name adc_dco_p -waveform {0.000 3.125} [get_ports adc_dco_p_0]


set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -min -add_delay 1.090 [get_ports {adc_out_1p_0[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -max -add_delay 2.035 [get_ports {adc_out_1p_0[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -min -add_delay 1.090 [get_ports {adc_out_1p_0[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -max -add_delay 2.035 [get_ports {adc_out_1p_0[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -min -add_delay 1.090 [get_ports {adc_out_1n_0[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -max -add_delay 2.035 [get_ports {adc_out_1n_0[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -min -add_delay 1.090 [get_ports {adc_out_1n_0[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -max -add_delay 2.035 [get_ports {adc_out_1n_0[*]}]

set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -min -add_delay 1.090 [get_ports {adc_out_2p_0[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -max -add_delay 2.035 [get_ports {adc_out_2p_0[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -min -add_delay 1.090 [get_ports {adc_out_2p_0[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -max -add_delay 2.035 [get_ports {adc_out_2p_0[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -min -add_delay 1.090 [get_ports {adc_out_2n_0[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -max -add_delay 2.035 [get_ports {adc_out_2n_0[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -min -add_delay 1.090 [get_ports {adc_out_2n_0[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -max -add_delay 2.035 [get_ports {adc_out_2n_0[*]}]

set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -min -add_delay 1.090 [get_ports {adc_fr_p_0}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -max -add_delay 2.035 [get_ports {adc_fr_p_0}]
set_input_delay -clock [get_clocks adc_dco_p] -min -add_delay 1.090 [get_ports {adc_fr_p_0}]
set_input_delay -clock [get_clocks adc_dco_p] -max -add_delay 2.035 [get_ports {adc_fr_p_0}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -min -add_delay 1.090 [get_ports {adc_fr_n_0}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -max -add_delay 2.035 [get_ports {adc_fr_n_0}]
set_input_delay -clock [get_clocks adc_dco_p] -min -add_delay 1.090 [get_ports {adc_fr_n_0}]
set_input_delay -clock [get_clocks adc_dco_p] -max -add_delay 2.035 [get_ports {adc_fr_n_0}]

set_false_path -from [get_clocks -of_objects [get_pins adc_dac_example_i/clk_wiz_0/inst/mmcme4_adv_inst/CLKOUT0]] -to [get_clocks -of_objects [get_pins adc_dac_example_i/frontpanel_0/inst/okHI/mmcm0/CLKOUT0]]

set_false_path -from [get_clocks -of_objects [get_pins adc_dac_example_i/frontpanel_0/inst/okHI/mmcm0/CLKOUT0]] -to [get_clocks -of_objects [get_pins adc_dac_example_i/xem8320_adc_0/inst/adc_impl/adc_dco_impl/mmcm_dco/CLKOUT1]]
set_false_path -from [get_clocks -of_objects [get_pins adc_dac_example_i/xem8320_adc_0/inst/adc_impl/adc_dco_impl/mmcm_dco/CLKOUT1]] -to [get_clocks -of_objects [get_pins adc_dac_example_i/frontpanel_0/inst/okHI/mmcm0/CLKOUT0]]
