...
export class SZYGYCamera extends FrontPanelCamera {
    ...
    public override async SetSkips(skips: MatrixDimensions): Promise<void> {
        ...
        await this.FrontPanel.setWireInValue(0x02, frameBufferSize & 0xffff, 0xffffffff);
        await this.FrontPanel.setWireInValue(0x03, frameBufferSize >> 16, 0xffffffff);
    ...
    protected async SetupOptimizedRegisterSet(): Promise<void> {
        ...
        await this._DeviceI2C.Write16(AR0330Device.AR0330_REG_VT_PIX_CLK_DIV, 0x0005);
        await this._DeviceI2C.Write16(AR0330Device.AR0330_REG_PRE_PLL_CLK_DIV, 0x0002);
        await this._DeviceI2C.Write16(AR0330Device.AR0330_REG_PLL_MULTIPLIER, 0x0028);
        await this._DeviceI2C.Write16(AR0330Device.AR0330_REG_OP_SYS_CLK_DIV, 0x0001); 
