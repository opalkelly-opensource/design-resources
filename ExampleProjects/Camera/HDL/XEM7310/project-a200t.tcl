...
# 
# To run:
# 1. Open Vivado GUI and "cd" to this directory containing project-a200t.tcl
#    using the TCL console.
# 2. Run "source project-a200t.tcl"
...
start_gui
create_project Camera_7310 Vivado-a200t -part xc7a200tfbg484-1
add_files -norecurse {\
host_if.v \
mem_arbiter.v \
image_if.v \
...
set_property -dict [list CONFIG.XML_INPUT_FILE {../../../../../mig_a200t.prj}] [get_ips ddr3_256_32]
