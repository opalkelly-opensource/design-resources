...
create_clock -period 4.166 -name slvsc_p [get_ports slvsc_p]
set_input_delay -clock [get_clocks slvsc_p] -clock_fall -min -add_delay 0.625 [get_ports {slvs_n[*]}]
set_input_delay -clock [get_clocks slvsc_p] -clock_fall -max -add_delay 1.458 [get_ports {slvs_n[*]}]
set_input_delay -clock [get_clocks slvsc_p] -min -add_delay 0.625 [get_ports {slvs_n[*]}]
set_input_delay -clock [get_clocks slvsc_p] -max -add_delay 1.458 [get_ports {slvs_n[*]}]
set_input_delay -clock [get_clocks slvsc_p] -clock_fall -min -add_delay 0.625 [get_ports {slvs_p[*]}]
set_input_delay -clock [get_clocks slvsc_p] -clock_fall -max -add_delay 1.458 [get_ports {slvs_p[*]}]
set_input_delay -clock [get_clocks slvsc_p] -min -add_delay 0.625 [get_ports {slvs_p[*]}]
set_input_delay -clock [get_clocks slvsc_p] -max -add_delay 1.458 [get_ports {slvs_p[*]}]
