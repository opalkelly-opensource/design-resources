...
# PORTA-5 (S0_D0P)
set_property PACKAGE_PIN L18 [get_ports {slvs_p[0]}]

# PORTA-7 (S2_D0N)
set_property PACKAGE_PIN K18 [get_ports {slvs_n[0]}]
...
# PORTA-9 (S4_D2P)
set_property PACKAGE_PIN M20 [get_ports {slvs_p[1]}]

# PORTA-11 (S6_D2N)
set_property PACKAGE_PIN M21 [get_ports {slvs_n[1]}]

# PORTA-13 (S8_D4P)
set_property PACKAGE_PIN J19 [get_ports {slvs_p[2]}]
# PORTA-15 (S10_D4N)
set_property PACKAGE_PIN J20 [get_ports {slvs_n[2]}]

# PORTA-17 (S12_D6P)
set_property PACKAGE_PIN L22 [get_ports {slvs_p[3]}]

# PORTA-19 (S14_D6N)
set_property PACKAGE_PIN L23 [get_ports {slvs_n[3]}]

# PORTA-21 (S16)
set_property PACKAGE_PIN H24 [get_ports {cam_sdata}]
set_property IOSTANDARD LVCMOS18 [get_ports {cam_sdata}]

# PORTA-23 (S18)
set_property PACKAGE_PIN J21 [get_ports {cam_sclk}]
set_property IOSTANDARD LVCMOS18 [get_ports {cam_sclk}]
...
# PORTA-33 (P2C_CLKP)
set_property PACKAGE_PIN J23 [get_ports {slvsc_p}]
set_property IOSTANDARD LVDS [get_ports {slvsc_p}]
...
# PORTA-35 (P2C_CLKN)
set_property PACKAGE_PIN J24 [get_ports {slvsc_n}]
set_property IOSTANDARD LVDS [get_ports {slvsc_n}]

set_property IOSTANDARD LVDS [get_ports {slvs_p[*]}]
set_property IOSTANDARD LVDS [get_ports {slvs_n[*]}]
...
############################################################################
## SYZYGY PORTB - SZG-CAMERA Peripheral
############################################################################

# PORTC-5 (S0_D0P)
set_property PACKAGE_PIN A22 [get_ports {slvs_p_2[0]}]

# PORTC-7 (S2_D0N)
set_property PACKAGE_PIN A23 [get_ports {slvs_n_2[0]}]

# PORTC-8 (S3_D1N)
set_property PACKAGE_PIN A25 [get_ports {cam_reset_b_2}]
set_property IOSTANDARD LVCMOS18 [get_ports {cam_reset_b_2}]

# PORTC-9 (S4_D2P)
set_property PACKAGE_PIN E21 [get_ports {slvs_p_2[1]}]

# PORTC-11 (S6_D2N)
set_property PACKAGE_PIN D21 [get_ports {slvs_n_2[1]}]

# PORTC-13 (S8_D4P)
set_property PACKAGE_PIN E25 [get_ports {slvs_p_2[2]}]
# PORTC-15 (S10_D4N)
set_property PACKAGE_PIN E26 [get_ports {slvs_n_2[2]}]

# PORTC-17 (S12_D6P)
set_property PACKAGE_PIN F23 [get_ports {slvs_p_2[3]}]

# PORTC-19 (S14_D6N)
set_property PACKAGE_PIN E23 [get_ports {slvs_n_2[3]}]

# PORTC-21 (S16)
set_property PACKAGE_PIN D26 [get_ports {cam_sdata_2}]
set_property IOSTANDARD LVCMOS18 [get_ports {cam_sdata_2}]

# PORTC-23 (S18)
set_property PACKAGE_PIN B26 [get_ports {cam_sclk_2}]
set_property IOSTANDARD LVCMOS18 [get_ports {cam_sclk_2}]

# PORTC-25 (S20)
set_property PACKAGE_PIN D23 [get_ports {cam_saddr_2}]
set_property IOSTANDARD LVCMOS18 [get_ports {cam_saddr_2}]

# PORTC-33 (P2C_CLKP)
set_property PACKAGE_PIN G24 [get_ports {slvsc_p_2}]
set_property IOSTANDARD LVDS [get_ports {slvsc_p_2}]

# PORTC-34 (C2P_CLKP)
set_property PACKAGE_PIN H21 [get_ports {cam_extclk_2}]
set_property IOSTANDARD LVCMOS18 [get_ports {cam_extclk_2}]

# PORTC-35 (P2C_CLKN)
set_property PACKAGE_PIN G25 [get_ports {slvsc_n_2}]
set_property IOSTANDARD LVDS [get_ports {slvsc_n_2}]

set_property IOSTANDARD LVDS [get_ports {slvs_p_2[*]}]
set_property IOSTANDARD LVDS [get_ports {slvs_n_2[*]}]

create_clock -period 6.80 -name slvsc_p_2 -waveform {0.000 3.401} [get_ports slvsc_p_2]
set_input_delay -clock [get_clocks slvsc_p_2] -clock_fall -min -add_delay 1.020 [get_ports {slvs_n_2[*]}]
set_input_delay -clock [get_clocks slvsc_p_2] -clock_fall -max -add_delay 2.381 [get_ports {slvs_n_2[*]}]
set_input_delay -clock [get_clocks slvsc_p_2] -min -add_delay 1.020 [get_ports {slvs_n_2[*]}]
set_input_delay -clock [get_clocks slvsc_p_2] -max -add_delay 2.381 [get_ports {slvs_n_2[*]}]
set_input_delay -clock [get_clocks slvsc_p_2] -clock_fall -min -add_delay 1.020 [get_ports {slvs_p_2[*]}]
set_input_delay -clock [get_clocks slvsc_p_2] -clock_fall -max -add_delay 2.381 [get_ports {slvs_p_2[*]}]
set_input_delay -clock [get_clocks slvsc_p_2] -min -add_delay 1.020 [get_ports {slvs_p_2[*]}]
set_input_delay -clock [get_clocks slvsc_p_2] -max -add_delay 2.381 [get_ports {slvs_p_2[*]}]

############################################################################
## SYZYGY PORTC - SZG-CAMERA Peripheral
############################################################################

# PORTC-5 (S0_D0P)
set_property PACKAGE_PIN F20 [get_ports {slvs_p_3[0]}]

# PORTC-7 (S2_D0N)
set_property PACKAGE_PIN E20 [get_ports {slvs_n_3[0]}]

# PORTC-8 (S3_D1N)
set_property PACKAGE_PIN C19 [get_ports {cam_reset_b_3}]
set_property IOSTANDARD LVCMOS18 [get_ports {cam_reset_b_3}]

# PORTC-9 (S4_D2P)
set_property PACKAGE_PIN H18 [get_ports {slvs_p_3[1]}]

# PORTC-11 (S6_D2N)
set_property PACKAGE_PIN H19 [get_ports {slvs_n_3[1]}]

# PORTC-13 (S8_D4P)
set_property PACKAGE_PIN F18 [get_ports {slvs_p_3[2]}]
# PORTC-15 (S10_D4N)
set_property PACKAGE_PIN F19 [get_ports {slvs_n_3[2]}]

# PORTC-17 (S12_D6P)
set_property PACKAGE_PIN E16 [get_ports {slvs_p_3[3]}]

# PORTC-19 (S14_D6N)
set_property PACKAGE_PIN E17 [get_ports {slvs_n_3[3]}]

# PORTC-21 (S16)
set_property PACKAGE_PIN A19 [get_ports {cam_sdata_3}]
set_property IOSTANDARD LVCMOS18 [get_ports {cam_sdata_3}]

# PORTC-23 (S18)
set_property PACKAGE_PIN H16 [get_ports {cam_sclk_3}]
set_property IOSTANDARD LVCMOS18 [get_ports {cam_sclk_3}]

# PORTC-25 (S20)
set_property PACKAGE_PIN D19 [get_ports {cam_saddr_3}]
set_property IOSTANDARD LVCMOS18 [get_ports {cam_saddr_3}]

# PORTC-33 (P2C_CLKP)
set_property PACKAGE_PIN E18 [get_ports {slvsc_p_3}]
set_property IOSTANDARD LVDS [get_ports {slvsc_p_3}]

# PORTC-34 (C2P_CLKP)
set_property PACKAGE_PIN C17 [get_ports {cam_extclk_3}]
set_property IOSTANDARD LVCMOS18 [get_ports {cam_extclk_3}]

# PORTC-35 (P2C_CLKN)
set_property PACKAGE_PIN D18 [get_ports {slvsc_n_3}]
set_property IOSTANDARD LVDS [get_ports {slvsc_n_3}]

set_property IOSTANDARD LVDS [get_ports {slvs_p_3[*]}]
set_property IOSTANDARD LVDS [get_ports {slvs_n_3[*]}]

create_clock -period 6.80 -name slvsc_p_3 -waveform {0.000 3.401} [get_ports slvsc_p_3]
set_input_delay -clock [get_clocks slvsc_p_3] -clock_fall -min -add_delay 1.020 [get_ports {slvs_n_3[*]}]
set_input_delay -clock [get_clocks slvsc_p_3] -clock_fall -max -add_delay 2.381 [get_ports {slvs_n_3[*]}]
set_input_delay -clock [get_clocks slvsc_p_3] -min -add_delay 1.020 [get_ports {slvs_n_3[*]}]
set_input_delay -clock [get_clocks slvsc_p_3] -max -add_delay 2.381 [get_ports {slvs_n_3[*]}]
set_input_delay -clock [get_clocks slvsc_p_3] -clock_fall -min -add_delay 1.020 [get_ports {slvs_p_3[*]}]
set_input_delay -clock [get_clocks slvsc_p_3] -clock_fall -max -add_delay 2.381 [get_ports {slvs_p_3[*]}]
set_input_delay -clock [get_clocks slvsc_p_3] -min -add_delay 1.020 [get_ports {slvs_p_3[*]}]
set_input_delay -clock [get_clocks slvsc_p_3] -max -add_delay 2.381 [get_ports {slvs_p_3[*]}]
...
## System Clock
############################################################################
create_clock -period 10 -name sys_clk [get_ports sys_clk_p]
...
-group [get_clocks -include_generated_clocks slvsc_p_3] \
-group [get_clocks -include_generated_clocks slvsc_p_2] \
-group [get_clocks -include_generated_clocks slvsc_p] \
-group [get_clocks -include_generated_clocks sys_clk] \
-group [get_clocks -include_generated_clocks okUH0] \
-group [get_clocks -include_generated_clocks ddr4_clk_p] \
-group [get_clocks -include_generated_clocks clk_wiz_fabric_i/inst/clk_in1]