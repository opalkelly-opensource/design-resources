...
#--------------------------------------------------------------------
start_gui
create_project szg_mipi_8320 Vivado -part xcau25p-ffvb676-2-e
add_files -norecurse {\
../../sync_bus.v \
../../sync_trig.v \
../../sync_reset.v \
...
create_ip -name mipi_csi2_rx_subsystem -vendor xilinx.com -library ip -module_name mipi_csi2_rx_subsystem_0
set_property -dict [list \
