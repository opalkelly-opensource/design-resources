//------------------------------------------------------------------------
// okcamera - Top-level SZG-MIPI-8320(Pcam connected to Camera 1) connected 
...
//    memif_clk         - Memory interface clock provided by MIG interface
//    dphy_clk_200M     - Clock for MIPI CSI-2 RX Subsystem. Must be 200 MHz. Provided by MMCM.
//    pix_clk           - Clock for MIPI CSI-2 RX Subsystem video interface. Provided by MMCM.
//    
//
...
(
    ...
    //SZG-CAMERA
    inout  wire        pcam_sclk,
    inout  wire        pcam_sdata,
    output wire        pcam_power_en,
...
// ep00wire[0] is reset_syspll in past devices that used the MIG to generate output clocks.
...
// Outputs to the PCB
assign pcam_power_en              = ep06wire[0];
...
// The I2C controller is used to configure the Pcam. You can read about this
...
i2cController #(
    ...
    .i2c_sclk                   (pcam_sclk),                  // inout
    .i2c_sdat                   (pcam_sdata)                  // inout
);
