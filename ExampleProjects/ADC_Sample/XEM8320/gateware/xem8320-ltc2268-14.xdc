...
create_clock -period 2.000 -name adc_dco_p -waveform {0.000 1.000} [get_ports adc_dco_p]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -min -add_delay .350 [get_ports {adc_out_1p[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -max -add_delay .650 [get_ports {adc_out_1p[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -min -add_delay .350 [get_ports {adc_out_1p[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -max -add_delay .650 [get_ports {adc_out_1p[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -min -add_delay .350 [get_ports {adc_out_1n[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -max -add_delay .650 [get_ports {adc_out_1n[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -min -add_delay .350 [get_ports {adc_out_1n[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -max -add_delay .650 [get_ports {adc_out_1n[*]}]

set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -min -add_delay .350 [get_ports {adc_out_2p[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -max -add_delay .650 [get_ports {adc_out_2p[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -min -add_delay .350 [get_ports {adc_out_2p[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -max -add_delay .650 [get_ports {adc_out_2p[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -min -add_delay .350 [get_ports {adc_out_2n[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -max -add_delay .650 [get_ports {adc_out_2n[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -min -add_delay .350 [get_ports {adc_out_2n[*]}]
set_input_delay -clock [get_clocks adc_dco_p] -max -add_delay .650 [get_ports {adc_out_2n[*]}]

set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -min -add_delay .350 [get_ports {adc_fr_p}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -max -add_delay .650 [get_ports {adc_fr_p}]
set_input_delay -clock [get_clocks adc_dco_p] -min -add_delay .350 [get_ports {adc_fr_p}]
set_input_delay -clock [get_clocks adc_dco_p] -max -add_delay .650 [get_ports {adc_fr_p}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -min -add_delay .350 [get_ports {adc_fr_n}]
set_input_delay -clock [get_clocks adc_dco_p] -clock_fall -max -add_delay .650 [get_ports {adc_fr_n}]
set_input_delay -clock [get_clocks adc_dco_p] -min -add_delay .350 [get_ports {adc_fr_n}]
set_input_delay -clock [get_clocks adc_dco_p] -max -add_delay .650 [get_ports {adc_fr_n}]
